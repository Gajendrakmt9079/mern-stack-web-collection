...
import { Link } from "react-router-dom";
 ...
 export  const Resiterdone = () => {
	return (
		<section className="py-14 md:py-24 h-[50vh] text-zinc-900 e relative overflow-hidden z-10">
			<div className="container p-4 mx-auto">
				<div className="grid grid-cols-12">
					

					<div className="col-span-12">
						<div className="  text-center flex flex-col justify-center items-center mt-12 px-6 md:px-10 py-10 md:py-16 rounded-md dark:text-white">
							...
							<h1 className="text-3xl md:text-[44px] leading-tight font-medium mt-4 mb-2">
								Your Registetion  is Successful
							</h1>
							<p className="">
