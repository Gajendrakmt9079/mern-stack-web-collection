...
const products = [
	{ id: 1, name: "Your Product", price: 15.0 },
...
const InputItem = ({ input }) => {
	return (
		<div className="flex flex-col gap-2 mt-6">
			<label htmlFor={input.for} className="font-medium">
				{input.level}{" "}
...
const Payment = ({ products }) => {
	...
	return (
		<div className="bg-white  p-6 lg:p-12 rounded-md">
			<div className="">
				<h4 className="text-2xl font-medium mb-12">Your Order</h4>
				...
				<div className="grid grid-cols-3 gap-6">
					...
					<hr className="col-span-3 my-0 dark:border-slate-700" />
			...
			<div className="bg-gray-100  p-4 lg:p-6 mt-12">
				<form>
					...
					<button onClick={()=>{navigate('/sucess')}} className="text-white bg-blue-600 hover:bg-opacity-90 p-4 px-9 flex justify-center items-center leading-none h-full rounded-md w-full">
						Pay Now
					</button>
				</form>
			</div>
...
const Checkout = () => {
    const navigate = useNavigate();
	return (
		<section className="py-14 md:py-0 bg-white text-zinc-900 relative overflow-hidden z-10">
